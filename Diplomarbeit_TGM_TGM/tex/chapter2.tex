...
\section{JavaScript, HTML5,CSS3}
 ...
 HTML5 is a cooperation between the World Wide Web Consortium (W3C) and the Web Hypertext Application Technology Working Group (WHATWG).\\\\
  ...
  As described in the graphic every time a program needs to send data from the browser to the server it creates an XMLHTTPRequest object. This request is then accepted or denied by the server and a response will be send back to the browser where it can be displayed or processed. 
  ...
  \begin{description}
     \item[There are five main releases of MS SQL Server ]~\par
     \begin{enumerate}
  ...
  \begin{figure}[H]
  \centering
  \includegraphics[width=180mm,height=180mm,keepaspectratio]{graphics/sqlserver.PNG}
  \caption{SQl Server 2008 overview}
  \end{figure} 
  \newpage
  \section{Microsoft Dynamics Navision}
  ...
  Microsoft Dynamics Navision saves data in a Microsoft SQL Server database.The databases consist of several tables, which can be created,edited and deleted.Table's are the basic modules of the database and are fundamental.It allows to easily modify,delete and display data on the run.
  \\\\
  \begin{figure}[htbp]
  \centering
  ...
  \newpage
  \subsubsection{Pages}
  Microsoft Dynamics Navsion provides with pages a way to display and organize data. It can either be accessed via a client and displayed graphically or accessed trough a web service.
  A page is a XML object which consists of several properties and code. The following figure shows a example page with a list of customers
  \\\\
  \begin{figure}[htbp]
  \centering
