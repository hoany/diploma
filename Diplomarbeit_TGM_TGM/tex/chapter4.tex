...
Listing 4.5 shows the function behind each button. Some buttons only link to another, other invoke specific functions like \textit{LocalStorageWriteId()}.
\\
\newpage
\clearpage
\begin{lstlisting}[language=html, caption= 
...
\begin{figure}[h]
\centering
\includegraphics[width=0.32\linewidth]{graphics/chapter4/6.png}
\caption{Table}
\end{figure}
\clearpage
...
\begin{figure}[h]
\centering
\includegraphics[width=0.32\linewidth]{graphics/chapter4/fg6.png}
\caption{Selector}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\linewidth]{graphics/bgfn.PNG}
\caption{Condition}
\end{figure}
