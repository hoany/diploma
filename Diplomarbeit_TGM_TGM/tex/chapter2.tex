...
It's also possible to create executable .Jar files. They behaves similar to .exe file in Windows. They can be executed with a double click, when Java is installed on the system. 
